    ...
    <>
      ...
      <Layout>
        <div className="h-fit text-white p-10 bg-black overflow-x-hidden flex flex-col justify-center items-center">
          ...
          <p className="p-3 text-green-500 text-xl">Good luck guessing this word</p>
          ...
          <div>
            <div className="mt-3 flex flex-col justify-center items-center">
              <div className="flex flex-row">
                ...
                <button className="text-xl ml-3 p-5 transform duration-300 content-center bg-transparent hover:bg-white bg-green-500 font-semibold hover:text-black border border-green-100 hover:border-transparent rounded" onClick={handleSubtractTries}>Enter</button>
              </div>
