...
function GameCard({ rank }: Props) {
    ...
    return (
        <div className="min-w-full rounded-2xl overflow-hidden shadow-xl bg-black">
            ...
            <div className={"py-10 text-black flex justify-center "+ tempImageBackgrounds[Math.floor(Math.random()*tempImageBackgrounds.length)]}></div>
            <div className="flex flex-col justify-between">
                ...
                <div className="flex flex-col">
                    <div className="px-6 py-2 flex flex-row justify-center items-center">
                        <button className="transition ease-in-out delay-100 hover:scale-110 transform duration-300 content-center bg-transparent hover:bg-white bg-indigo-700 font-semibold hover:text-black py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                            Play Wordpunch
                        </button>
                    </div>
                    <div className="px-6 pt-5 pb-4 flex flex-row justify-center items-center flex-wrap">
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#wordpunch</span>
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#stumped</span>
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#goodguess</span>
                    </div>
                </div>
            </div>
        </div>
